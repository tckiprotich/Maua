    ...
    <div class="container p-6 mx-auto">
        <div class="lg:flex">
            <div class="w-full -mx-6 lg:w-2/5">
                <div class="px-6">
                    <div>
                        <a href="https://tckiprotich.com/" class="text-xl font-bold text-gray-800 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">Brand</a>
                    </div>
                    ...
                    <div class="flex mt-6 -mx-2">
                        <a href="https://Reddit.com/iphurts"
            ...
            <div class="mt-6 lg:mt-0 lg:flex-1">
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    ...
                    <div>
                        ...
                        <a href="https://www.tckiprotich.com" class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Personal website</a>
                        <a href="mau.vercel.app" class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Music</a>
                        <a href="maua.vercel.app" class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Maua</a>
                    </div>
                    ...
                    <div>
                        ...
                        <span class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline"></span>
                        <span class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">collins@tckiprotich.com</span>
                    </div>
                </div>
            </div>
        </div>
